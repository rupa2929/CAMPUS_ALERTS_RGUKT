           ...
           <div class="form-container student">
            ...
            <form class="questions-form">
                <div id="stu-regi1">
                    ...
                    <p class="btn"name="signup" onclick="showdetails()">sign up</p>
                    <div class="link">
            ...
            <div class="form-container sign-in">
                <form action="#">
                    ...
                    <div class="forgot-pass link"><a href="#" class="forgot-link">forgot password?</a></div>
