...
$sender = $_POST['event-from'];
$message = $_POST['event-message'];
...
if ($to === "all") {
    ...
    $pucGroup = $_POST['eventpucGroup'];
    $pucSection = $_POST['eventpucSection'];
} elseif ($to === "engineering") {
    $engineeringYear = $_POST['eventengineeringYear'];
    $engineeringBranch = $_POST['eventengineeringBranch'];
    $engineeringSection = $_POST['eventengineeringSection'];
}

// Construct the SQL query
$sql = "INSERT INTO messages4 (category,sender, messag, allPUC, allengineering, pucGroup, pucSection, engineeringYear, engineeringBranch, engineeringSection) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?)";
